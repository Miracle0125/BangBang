...
public class MainAssignmentsListAdapter implements ListItem.Listener {
    ...
    private void initView(ViewHolder h, View v) {
        ...
        h.portrait = (SimpleDraweeView) v.findViewById(R.id.item_portrait);
        h.tv_distance = (TextView) v.findViewById(R.id.main_item_distance);
    }
