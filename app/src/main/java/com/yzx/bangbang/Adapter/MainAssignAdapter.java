...
public class MainAssignAdapter {
    ...
    public ListItem inflate(Assignment assignment, ListItem view) {
        ...
        if (numOfImages > 0) {
            ...
            item_imageViews.add((ImageView) v.findViewById(R.id.main_item_image0));
            item_imageViews.add((ImageView) v.findViewById(R.id.main_item_image1));
            item_imageViews.add((ImageView) v.findViewById(R.id.main_item_image2));
            if (!v.layoutExpanded)
                LayoutExpandForImage();
            setImageBackground();
        } else if (isReload) {
            RelativeLayout container = (RelativeLayout) v.findViewById(R.id.main_image_container);
    ...
    private void LayoutExpandForImage() {
        ...
        params.addRule(RelativeLayout.BELOW, R.id.main_image_container);
